const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "Email",
      url: "mailto:zaynbu269@gmail.com",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300"
